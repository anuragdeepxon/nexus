  ...
  <tr>
   <td style="padding: 20px;">
    ...
    <div style="display: flex; justify-content: space-evenly; padding:10px">
     ...
     <div>
      <div class="progress" data-progress="45" style="display: flex; width: 100px; height: 100px; border-radius: 50%; background: conic-gradient(#51bd56 45deg, #f5f5f5 0deg); font-size: 0; color: #428518;
     ...
     <div style="text-align: center;">
      <div class="progress" data-progress="{{ $data['mobile']['categories']['performance']['score'] }}" style="--progress: {{ $data['mobile']['categories']['performance']['degree'] }}deg; ">
     ...
     <div style="text-align: center;">
      <div class="progress" data-progress="{{ $data['mobile']['categories']['accessibility']['score'] }}" style="--progress: {{ $data['mobile']['categories']['accessibility']['degree'] }}deg;">
     ...
     <div style="text-align: center;">
      <div class="progress" data-progress="{{ $data['mobile']['categories']['seo']['score'] }}" style="--progress: {{ $data['mobile']['categories']['seo']['degree'] }}deg;">
     ...
     <div style="text-align: center;">
      <div class="progress" data-progress="{{ $data['mobile']['categories']['best_practices']['score'] }}" style="--progress: {{ $data['mobile']['categories']['best_practices']['degree'] }}deg;">
    ...
    <div style="display: flex; justify-content: space-evenly; padding:10px">
     ...
     <div style="text-align: center;">
      <div class="progress" data-progress="{{ $data['desktop']['categories']['performance']['score'] }}" style="--progress: {{ $data['desktop']['categories']['performance']['degree'] }}deg;">
     ...
     <div style="text-align: center;">
      <div class="progress" data-progress="{{ $data['desktop']['categories']['accessibility']['score'] }}" style="--progress: {{ $data['desktop']['categories']['accessibility']['degree'] }}deg;">
     ...
     <div style="text-align: center;">
      <div class="progress" data-progress="{{ $data['desktop']['categories']['seo']['score'] }}" style="--progress: {{ $data['desktop']['categories']['seo']['degree'] }}deg;">
     ...
     <div style="text-align: center;">
      <div class="progress" data-progress="{{ $data['desktop']['categories']['best_practices']['score'] }}" style="--progress: {{ $data['desktop']['categories']['best_practices']['degree'] }}deg;">
    ...
    <style>
     .progress {
      ...
      height: 100px;
      border-radius: 50%;
      background: conic-gradient(#51bd56 var(--progress), #f5f5f5 0deg);
      font-size: 0;
      color: #428518;
     }
